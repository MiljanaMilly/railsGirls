...
class Idea2sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create idea2" do
    assert_difference('Idea2.count') do
      post idea2s_url, params: { idea2: { description: @idea2.description, name: @idea2.name, picture: @idea2.picture } }
    end
  ...
  test "should update idea2" do
    patch idea2_url(@idea2), params: { idea2: { description: @idea2.description, name: @idea2.name, picture: @idea2.picture } }
